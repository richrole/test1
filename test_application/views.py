...
from test_application.models import Test
from work_application.models import Work


def test_page(request):
    return render_mako_context(request, "/test_application/test.html")
...
def save(request):
    ...
    Test.objects.create(biz_id=test['biz_id'],
                        biz_name=test['biz_name'],
                        name=test['name'],
                        type=test['type'],
                        res=test['res'],
                        phone=test['phone'],
